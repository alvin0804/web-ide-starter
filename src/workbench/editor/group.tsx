...
import {
    ...
    groupContrinerNoHandlerAreaClassName,
...
export function EditorGroup(props: IEditorGroupProps & IEditorController) {
    ...
    const isShowHandler = isActiveGroup && ((tab?.id ?? '') !== 'Setting')
    ...
    return (
        <div className={groupClassName}>
            ...
            <EditorHandler isShowHandler={isShowHandler} handlers={tab.handlers} onClickHandlers={onClickHandlers}></EditorHandler>
            <div className={classNames(groupContainerClassName, isShowHandler ? '' : groupContrinerNoHandlerAreaClassName)}>
                {
