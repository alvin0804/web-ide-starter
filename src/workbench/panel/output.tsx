...
import { TerminalEditor } from 'mo/components/terminal';
...
const data = [
    ...
    "<11>httpd[25859]: [error] [client xx.xx.xx.xx] File does not exist: /usr/local/installed/apache/htdocs/squirrelmail/_vti_bi 15:18:20.54 from xx.xx.xx.xx",
].join("\n");

const defaultClassName = prefixClaName('output');

function Output(props: IOutput) {
    // onUpdateEditorIns, data = ''
    const { id } = props;

    // const [data, setData] = useState('')

    const onUpdateEditorIns = (instance: editor.IStandaloneCodeEditor) => {
        // const model = instance.getModel();
        // setData(data)
        // instance.setValue(data);
        console.log("onUpdateEditorIns instance: ", instance);
    }
    return (
