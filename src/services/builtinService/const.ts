...
export const constants = {
    ...
    PANEL_SEARCH_RESULT: 'panel.searchResult.title',
    ...
    REFRESH_FOLDER_COMMAND_ID: 'explorer.refreshFolderList',
    ...
    EDITOR_MENU_QUICK_CREATE: 'editor.quickCreate',

    EDITOR_HANDLER_ENGINE: 'editor.handler.engine',
    EDITOR_HANDLER_ENGINE_PRESTO: 'editor.handler.engine.trino',
    EDITOR_HANDLER_ENGINE_SPARK_SQL: 'editor.handler.engine.antspark',
    EDITOR_HANDLER_START: 'editor.handler.start',
    EDITOR_HANDLER_STOP: 'editor.handler.stop',
    EDITOR_HANDLER_SAVE: 'editor.handler.save',
    EDITOR_HANDLER_ZOOM_IN: 'editor.handler.zoomIn',
    EDITOR_HANDLER_ZOOM_OUT: 'editor.handler.zoomOut',
    EDITOR_HANDLER_FORMAT: 'editor.handler.format',
    ...
    HISTORY_CASE_SENSITIVE_COMMAND_ID: 'history.matchCase',
    HISTORY_WHOLE_WORD_COMMAND_ID: 'history.matchWholeWord',
    HISTORY_REGULAR_EXPRESSION_COMMAND_ID: 'history.useRegularExpression',
    HISTORY_PRESERVE_CASE_COMMAND_ID: 'history.preserveCase',
    HISTORY_ACTIVITY_ITEM: 'sidebar.history.title',
    ...
    ACTIVITY_BAR_GLOBAL_LAYOUT_PANEL: 'global.menu.layoutPanel',
    ACTIVITY_BAR_GLOBAL_LAYOUT_SIDEBAR: 'global.menu.layoutSidebar',
...
export const modules = {
    ...
    ({
        ...
        toolbar: [
            ...
            {
                id: constants.REFRESH_FOLDER_COMMAND_ID,
                title: localize(
    ...
    builtInEditorInitialActions: () =>
        [
            {
                id: constants.EDITOR_MENU_QUICK_CREATE,
                name: '快速创建查询窗口',
                title: localize(
    ...
    builtInEditorInitialHandlers: () => ([
        // {
        //     id: constants.EDITOR_HANDLER_ENGINE,
        //     icon: "chevron-down",
        //     // name: "切换执行引擎",
        ...
        //     dataSource: [
        //         {
        //             id: constants.EDITOR_HANDLER_ENGINE_PRESTO,
        //             name: 'Presto 引擎',
        //             value: 'trino'
        //         },
        //         {
        //             id: constants.EDITOR_HANDLER_ENGINE_SPARK_SQL,
        //             name: 'SparkSQL 引擎',
        //             value: 'antspark'
        //         }
        //     ],
        ...
        // },
        {
            id: constants.EDITOR_HANDLER_START,
            icon: "debug-start",
            name: "执行(Ctrl+Enter)",
            handlerPosition: 'Left',
            handlerType: 'Button',
        ...
        {
            id: constants.EDITOR_HANDLER_STOP,
            icon: "stop-circle",
            name: "停止",
            handlerPosition: 'Left',
            handlerType: 'Button',
        ...
        {
            id: constants.EDITOR_HANDLER_SAVE,
            icon: "save",
            name: "保存",
            handlerPosition: 'Left',
            handlerType: 'Button',
        ...
        {
            id: constants.EDITOR_HANDLER_ZOOM_IN,
            icon: "zoom-in",
            name: "放大",
        ...
        {
            id: constants.EDITOR_HANDLER_ZOOM_OUT,
            icon: "zoom-out",
            name: "缩小",
            handlerPosition: 'Right',
            handlerType: 'Button',
        ...
        {
            id: constants.EDITOR_HANDLER_FORMAT,
            icon: "code",
            name: "格式化",
            handlerPosition: 'Right',
            handlerType: 'Button',
        }
    ]) as IEditorHandlerItem[],
    ...
    STATUS_PANEL_INFO: () => ({
        ...
        sortIndex: 1,
        data: {},
        name: 'Show/Hidden Result Panel'
    }),

    builtInPanelSearchResult: () => ({
        id: constants.PANEL_SEARCH_RESULT,
        name: localize(constants.PANEL_SEARCH_RESULT, 'Search Result'),
        data: null,
        sortIndex: 1,
        closable: false,
    } as IPanelItem),
    ...
    builtInHistoryActivityItem: () =>
    ({
        id: constants.HISTORY_ACTIVITY_ITEM,
        name: localize(constants.HISTORY_ACTIVITY_ITEM, 'Search'),
        title: localize(constants.HISTORY_ACTIVITY_ITEM, 'Search'),
        sortIndex: 2,
        icon: 'history',
    } as IActivityBarItem),

    builtInHistoryHeaderToolbar: () =>
        [
            {
    ...
    activityBarData: () =>
        [
            // {
            //     id: constants.ACTIVITY_BAR_GLOBAL_LAYOUT_PANEL,
            //     name: localize('menu.layoutPanel', '结果面板'),
            //     title: localize('menu.layoutPanel', '结果面板'),
