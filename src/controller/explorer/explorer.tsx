...
import { FileTypes, EditorTreeEvent, FolderTreeEvent } from 'mo/model';
    ...
    implements IExplorerController
{
    ...
    public readonly onToolbarClick = (
        ...
        switch (toolbarId) {
            ...
            case REFRESH_FOLDER_COMMAND_ID: {
                this.folderTreeController.onRefreshFolderList();
                break;
            }
